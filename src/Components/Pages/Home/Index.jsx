...
function Home() {
  ...
  const FAKETOKEN = getItemWithExpiration("fakeauth"); // code démo version statique (hébergement sans BDD) ++++++++++++++++++++++++++
  const TOKEN = getItemWithExpiration("auth");  // pour version API -----------------
  ...
  return (
    <>
      <div className="home-container">
        ...
        <p className="home-text home-button">
          <Link to="/galerie">Start now!</Link>
        </p>
      </div>
    </>
  );
